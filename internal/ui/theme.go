...
type designTokens struct {
	...
	spacingXLarge   float32
	cardRadius      float32
	railWidth       float32
	contentWidth    float32
	workspaceHeight float32
	resultWidth     float32
...
type palette struct {
	...
	resultEmptySurface color.Color
...
var appPalette = palette{
	...
	resultEmptySurface: color.NRGBA{R: 0xed, G: 0xee, B: 0xe7, A: 255},
	resultShadow:       color.NRGBA{R: 0x18, G: 0x21, B: 0x3d, A: 24},
